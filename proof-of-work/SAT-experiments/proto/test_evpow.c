...
timed_solve( uint8_t* prefix
	...
	int r = evpow_solve(prefix, prefix_size, answer, solution_hash, clauses_count, complexity_shift, complexity_mantissa, milliseconds_allowance, attempts_allowed, & attempts_count, fixed_bits_count, fixed_bits, NULL);
	clock_t end = clock();
