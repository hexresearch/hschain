...
, bytestring , bytestring-arbitrary, containers, cprng-aes, criterion
...
mkDerivation {
  ...
  testHaskellDepends = [
    async base base58-bytestring bytestring bytestring-arbitrary
    generic-arbitrary hedgehog hedgehog-quickcheck QuickCheck stm tasty
    tasty-hunit tasty-hedgehog
  ];
