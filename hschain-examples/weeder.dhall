{ roots = [ "^Main.main$"
          ...
          , "HSChain.Store.checkRequire"
          , "HSChain.Store.checkStorage"
          , "HSChain.Store.dbtRO"
          , "HSChain.Store.genesisBlockInvariant"
          , "HSChain.Store.hoistMempool"
          , "HSChain.Store.hoistMempoolCursor"
          , "HSChain.Store.initDatabase"
          , "HSChain.Store.nullMempool"
          , "HSChain.Store.require"
          , "HSChain.Store.runDBT"
          , "HSChain.Store.withDatabase"
